package com.jvega.configuration;
...
public class WebSecurityConfig {
	...
	// inyectando el manejo de autentificacion para redirigir al usuario si los
	// datos de ingreso son correctos
	@Autowired
	...
	// filtros para comparar la peticion (request) que llega a la aplicacion desde
	// la vista
	@Bean
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {

		// desabilitando proteccion cross-site prevention para el ingreso a la base de
		// datos h2
		http.csrf().disable();

		// desabilidando los cuadros de renderizado para el despliegue de la pagina por
		// defecto de la base de datos H2
