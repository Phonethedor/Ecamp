	...
	<div class="container mt-5 p-5">
		<div class="p-3">
			...
			<form action="agregar" method="post">
				<table>
					<tr>						
						<td class="p-2"><label for="nombre">Código:</label></td>
						<td><input class="form-control" type="text" name="codigo" placeholder="Código" /></td>
					</tr>
					<tr>
						<td class="p-2"><label for="clave">Nombre:</label></td>
						<td><input class="form-control" type="text" placeholder="Nombre" name="nombre" /></td>
					</tr>
					<tr>
						<td class="p-2"><label for="rut">Precio:</label></td>
						<td><input class="form-control" type="number" placeholder="Precio" name="precio" /></td>						
					</tr>
					<tr>
						<td class="p-2"><label for="rut">Stock:</label></td>
						<td><input class="form-control" type="number" placeholder="Stock" name="stock" /></td>						
					</tr>
					<tr>
						<td colspan="2">
