	...
	<body>
		...
		<div class="container mt-5 text-left">
			<div class="col-sm-6">
				...
				<p><c:out value="${producto.id}"></c:out></p>
				<p><c:out value="${producto.nombre}"></c:out></p>
				<p><c:out value="${producto.descripcion}"></c:out></p>
				<p><c:out value="${producto.precio}"></c:out></p>
			</div>
			<div class="btn-group mt-q col-sm-6" role="group" aria-label="Basic example">
				<a class="nav-link" href="listarProductos">
					<button type="button" class="btn btn-primary btn-sm">Listar Productos</button>
				</a> 
				<a class="nav-link" href="agregarProducto">
